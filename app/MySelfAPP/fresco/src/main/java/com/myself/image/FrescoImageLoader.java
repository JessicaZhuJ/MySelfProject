...
import com.myself.image.bigimage.MyRecyclePagerAdapter;
import com.myself.image.bigimage.RecycleAdapterForBigImage;
...
public class FrescoImageLoader {
    ...
    public static void init(final Context context, int cacheSizeInM,ILoader imageLoader){
        FrescoImageLoader.context = context;
